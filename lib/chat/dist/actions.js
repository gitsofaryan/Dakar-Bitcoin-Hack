...
var TOOL_MODEL = 'llama-3.1-70b-versatile';
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            ,
                ...
                role,
                ": 'user', content: 'Analyze Bitcoin right now and provide trading recommendation in JSON format only.' } ], model: 'llama-3.1-70b-versatile', temperature: 0.7, max_tokens: 1024, top_p: 1, stream: false }) let analysisText = chatCompletion.choices[0]?.message?.content || '' // Try to parse JSON from the response let analysis: any try ",

...
var TOOL_MODEL = 'openai/gpt-oss-120b';
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            ,
                ...
                React.createElement(message_2.SpinnerMessage, null),
            ...
            ,
                ...
                "textNode = ",
                React.createElement(message_1.BotMessage, { content: textStream.value }),
                "} if (done) ",
                textStream.done(),
                ...
                ") ",
                yield(React.createElement(message_1.BotCard, null,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(stock_chart_1.StockChart, { symbol: symbol, comparisonSymbols: comparisonSymbols }),
                    caption),
                ") } }, showStockPrice: ",
                description,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(stock_price_1.StockPrice, { props: symbol }),
                    caption),
                ") } }, showStockFinancials: ",
                description,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(stock_financials_1.StockFinancials, { props: symbol }),
                    caption),
                ") } }, showStockNews: ",
                description,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(stock_news_1.StockNews, { props: symbol }),
                    caption),
                ") } }, showStockScreener: ",
                description,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(stock_screener_1.StockScreener, null),
                    caption),
                ") } }, showMarketOverview: ",
                description,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(market_overview_1.MarketOverview, null),
                    caption),
                ") } }, showMarketHeatmap: ",
                description,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(market_heatmap_1.MarketHeatmap, null),
                    caption),
                ") } }, showETFHeatmap: ",
                description,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(etf_heatmap_1.ETFHeatmap, null),
                    caption),
                ") } }, showTrendingStocks: ",
                description,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(market_trending_1.MarketTrending, null),
                    caption),
                ") } }, analyzeBitcoin: ",
                description,
                ...
                ") ",
                yield(React.createElement(message_1.BotCard, null,
                    React.createElement("div", { className: "animate-pulse" }, "Analyzing Bitcoin market trends..."))),
                "try ",
            ,
                ...
                role,
                ": 'user', content: 'Analyze Bitcoin right now and provide trading recommendation in JSON format only.' } ], model: 'groq/compound', temperature: 0.7, max_tokens: 1024, top_p: 1, stream: false }) let analysisText = chatCompletion.choices[0]?.message?.content || '' // Try to parse JSON from the response let analysis: any try ",
            ...
            ,
                ...
                React.createElement(message_1.BotCard, null,
                    React.createElement(bitcoin_recommendation_1.BitcoinRecommendation, { recommendation: analysis.recommendation, confidence: analysis.confidence, reasoning: analysis.reasoning, price: analysis.price, rsi: analysis.rsi })),
                ") } catch (error: any) ",
            ,
                "return (",
                React.createElement(message_1.BotCard, null,
            ...
            ,
                ...
                React.createElement("div", { className: "border p-4" },
                    React.createElement("div", { className: "text-red-700 font-medium" },
                        "Error: ",
                        err.message),
                    React.createElement("a", { href: "https://github.com/bklieger-groq/stockbot-on-groq/issues", target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center text-sm text-red-800 hover:text-red-900" },
                        "If you think something has gone wrong, create an",
                        React.createElement("span", { className: "ml-1", style: { textDecoration: 'underline' } },
                            ' ',
                            "issue on Github."))),
                ") } } } export const AI = createAI",
                React.createElement(AIState, null),
                " UIState>(",
                actions,
                ": ",
                submitUserMessage,

...
import { TrendingUp, BarChart3, Bitcoin, Sparkles } from 'lucide-react'
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 leading-relaxed text-base">
            Lightning-fast AI assistant for Bitcoin analysis. Get real-time trading signals,
            price charts, market data, and AI-powered recommendations.
          </p>
        </div>
